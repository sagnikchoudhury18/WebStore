...
exports.getAllProducts = (req,res) =>{
    let limit = req.query.limit  ? parseInt(req.query.limit) : 8 //query passed on from the frontend by the user where if query is passed take the int val or else 8 as default
    let sortBy = req.sort.sortBy ? req.query.sortBy : "_id"  
